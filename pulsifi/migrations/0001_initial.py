    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_staff', models.ForeignKey(default=pulsifi.models_utils.get_random_staff_member, limit_choices_to={'is_staff': True}, on_delete=django.db.models.deletion.CASCADE, related_name='assigned_reports', to=settings.AUTH_USER_MODEL, verbose_name='Assigned Staff Member')),

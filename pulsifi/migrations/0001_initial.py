    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pulses', to='pulsifi.profile', verbose_name='Creator')),
            ],
            options={
                'verbose_name': 'Pulse',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PR', 'In progress'), ('RE', 'Rejected'), ('CN', 'Confirmed')], max_length=2, verbose_name='Status')),
                ('_date_time_created', models.DateTimeField(auto_now=True, verbose_name='Creation Date & Time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='pulsifi.profile', verbose_name='Creator')),
            ],
            options={
                'verbose_name': 'Reply',
            },

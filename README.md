...
<ul>
  ...
  <li>Always add full-stops to the end of Exception messages & Docstrings<nobr> (E.g <nobr><code>raise ValueError("That value is invalid.")</code></nobr> and <nobr><code>""" This function returns an int. """</code></nobr>)</nobr></li>
</ul>
